...
CREATE TABLE IF NOT EXISTS `sys_role_permission` (
    ...
    UNIQUE KEY `sys_role_permission_uk_role_permission` (`role_id`, `permission_id`),
...
CREATE TABLE IF NOT EXISTS `sys_user_role` (
    ...
    `role_id` BIGINT NOT NULL COMMENT '角色ID',
    UNIQUE KEY `sys_user_role_uk_user_role` (`user_id`, `role_id`),
...
CREATE TABLE IF NOT EXISTS `sys_file` (
    ...
    `create_time` DATETIME DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    INDEX `sys_file_idx_upload_user` (`upload_user_id`),
    INDEX `sys_file_idx_file_type` (`file_type`),
...
CREATE TABLE IF NOT EXISTS `sys_notification` (
    ...
    `create_time` DATETIME DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    INDEX `sys_notification_idx_user` (`user_id`),
    INDEX `sys_notification_idx_is_read` (`is_read`),
    INDEX `sys_notification_idx_type` (`type`),
    FOREIGN KEY (`user_id`) REFERENCES `dbs_user`(`id`)
...
CREATE TABLE IF NOT EXISTS `sys_log` (
    ...
    `create_time` DATETIME DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    INDEX `sys_log_idx_operator` (`operator_id`),
    INDEX `sys_log_idx_operation_type` (`operation_type`),
    INDEX `sys_log_idx_create_time` (`create_time`),
